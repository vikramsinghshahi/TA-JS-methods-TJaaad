...
console.log(`The index value of you in ${message} is ${message.indexOf("you")}`);

// Log the index of word "still" in message
console.log(`The index value of still in ${message} is ${message.indexOf("still")}`);

// Log the index of word "answers" in message

console.log(`The index value of answers in ${message} is ${message.indexOf("answers")}`);


// Log true or false based on whether the word "answers" exist in message or not

console.log(message.includes("answeers"));

...
function nameWithS(got) {
  ...
  return final.filter((name) => name.toLowerCase().includes("s"))
...
function nameWithA(got) {
  ...
  return final.filter((name) => name.toLowerCase().includes("a"))
...
function surnameWithS(got) {
  ...
  return final.filter((name) => name.split(" ")[1].toLowerCase().includes("s"))
}

function surnameWithA() {
  let final = everyone()

  return final.filter((name) => name.split(" ")[1].toLowerCase().includes("a"))
}
